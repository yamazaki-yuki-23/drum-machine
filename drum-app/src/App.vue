        ...
        <b-col cols="6" offset="3">
          <b-card class="mt-4">
            ...
            <b-row class="mx-2 mt-4">
              ...
              <b-form-input id="valume" v-model="volume" type="range" min="0" max="5" @change="volChange" />
            </b-row>
            <b-row class="mx-2 mt-4">
...
export default {
  ...
  methods: {
    powerChange() {
      // while the sound is on loop and the power is true
      stop()
    },
    ...
    volChange() {
      ...
      this.audio.volume = this.audio / 5
    },
    stop() {
      try {
